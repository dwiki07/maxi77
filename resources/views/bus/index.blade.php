                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>NamaBus</th><th>TipeBus</th><th>JumlahKursi</th><th>Harga</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($bus as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->namaBus }}</td><td>{{ $item->tipeBus }}</td><td>{{ $item->jumlahKursi }}</td><td>{{$item->hargaSewa}}</td>
                                        <td>
